...
bool ImGui_ImplVulkan_CreateFontsTexture(VkCommandBuffer command_buffer)
{
	...
	auto font_descriptor_set = (VkDescriptorSet)ImGui_ImplVulkan_AddTexture(g_FontSampler, g_FontView, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
...
VkDescriptorSet ImGui_ImplVulkan_CreateTexture()
{
	VkResult err;
...
void ImGui_ImplVulkan_UpdateTexture(VkDescriptorSet& descriptor_set, VkSampler sampler, VkImageView image_view, VkImageLayout image_layout)
{
	ImGui_ImplVulkan_InitInfo* v = &g_VulkanInitInfo;
	// Update the Descriptor Set:
	{
